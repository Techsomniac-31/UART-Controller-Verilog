...
Below is the **Elaborated Design Schematic** generated by Vivado, illustrating the synchronous signal routing across all sub-modules:

![UART RTL Top Level Schematic](RTL_Schematic.png)
